...
class ADS1220:
    def __init__(self, config):
        ...
        mux_options = {'AIN0_AIN1': 0x0000, 'AIN0_AIN2': 0x0001,
                       'AIN0_AIN3': 0x0010, 'AIN1_AIN2': 0x0011,
                       'AIN1_AIN3': 0x0100, 'AIN2_AIN3': 0x0101,
                       'AIN1_AIN0': 0x0110, 'AIN3_AIN2': 0x0111,
                       'AIN0_AVSS': 0x1000, 'AIN1_AVSS': 0x1001,
                       'AIN2_AVSS': 0x1010, 'AIN3_AVSS': 0x1011}
        ...
        force_pga_bypass = self.mux >= 0x1000
        self.pga_bypass = force_pga_bypass or self.pga_bypass
        # Voltage Reference
        self.vref_options = {'internal': 0x0, 'REF0': 0x01, 'REF1': 0x10,
                             'analog_supply': 0x11}
        self.vref = config.getchoice('vref', self.vref_options,
                                     default='internal')
        # check for conflict between REF1 and AIN0/AIN3
        mux_conflict = [0x0000, 0x0001, 0x0010, 0x0100, 0x0101, 0x0110, 0x0111,
                        0x1000, 0x1011]
        if self.vref == 0x11 and self.mux in mux_conflict:
